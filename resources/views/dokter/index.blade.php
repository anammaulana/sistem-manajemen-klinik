...
<div class="card" style="background-color: white; height: auto; padding: 20px; margin: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); border-radius: 8px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
       ...
       <div style="display: flex; gap: 10px;">
            ...
            <a href="{{route('dokter.create')}}" style="padding: 10px 15px; background-color: #007bff; color: white; text-decoration: none; border-radius: 5px;">
                 Tambah
            </a>
        </div>
    </div>
            ...
            <tr>
                ...
                <td style="padding: 10px; text-align: center;">Laki-laki</td>
                 <td style="padding: 10px; text-align: center;">
                    <a href="{{route('dokter.detail')}}" ><i class="fas fa-eye" style="margin-left: 10px; color:blue;"></i></a>
                    <a href="{{route('dokter.edit')}}" ><i class="fas fa-edit" style="margin-left: 10px; color: #e6a100;"></i></a>
